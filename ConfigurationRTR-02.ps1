...
netsh int ip set ad "WAN" static 192.168.255.128/24
netsh int ip set ad "Bou-LAN" static 192.168.128.254/24
...
netsh.exe routing ip nat add interface name="Bou-LAN" mode=PRIVATE 
